...
PUZZLE_COLORS = [PALETURQUOISE, PURPLE]
PUZZLEFONT = 50
PUZZLE_POSITIONS = [(LENGTH/12, WIDTH*5/54, LENGTH*5/36, WIDTH*5/36), (LENGTH*8/36, WIDTH*5/54, LENGTH*5/36, WIDTH*5/36), (LENGTH*13/36, WIDTH*5/54, LENGTH*5/36, WIDTH*5/36),(LENGTH*18/36, WIDTH*5/54, LENGTH*5/36, WIDTH*5/36),
						(LENGTH/12, WIDTH*25/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*8/36, WIDTH*25/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*13/36, WIDTH*25/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*18/36, WIDTH*25/108, LENGTH*5/36, WIDTH*5/36),
						(LENGTH/12, WIDTH*40/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*8/36, WIDTH*40/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*13/36, WIDTH*40/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*18/36, WIDTH*40/108, LENGTH*5/36, WIDTH*5/36),
						(LENGTH/12, WIDTH*55/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*8/36, WIDTH*55/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*13/36, WIDTH*55/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*18/36, WIDTH*55/108, LENGTH*5/36, WIDTH*5/36)]

'''The Options'''
OPTIONS = [1, 2, 3, 4]
OPTIONSFONT_COLORS = [BLACK, GREEN]
OPTIONS_COLORS = [PALETURQUOISE, YELLOW]
OPTIONSFONT = 50
OPTIONSCARD_POSITIONS = [(LENGTH*11/12, WIDTH*5/54, LENGTH*5/36, WIDTH*5/36), (LENGTH*11/12, WIDTH*25/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*11/12, WIDTH*40/108, LENGTH*5/36, WIDTH*5/36), (LENGTH*11/12, WIDTH*55/108, LENGTH*5/36, WIDTH*5/36)]
...
BUTTONFONT = 30
BUTTONCARD_POSITIONS = [(LENGTH/12, WIDTH*7/8, LENGTH*5/36, WIDTH*5/36), (LENGTH*11/12, WIDTH*7/8, LENGTH*5/36, WIDTH*5/36)]
...
def showInfo(text, screen, w, h):
	pygame.draw.rect(screen, WHITE, (0, 0, h, w))
